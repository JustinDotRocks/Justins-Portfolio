...
The component `<LetterGlitch \>` was taken from
...
> According to the license terms, any redistribution (including compiled or
> modified versions), you **must** retain the original copyright notice and the
> full license text. Copyright © 2025 Oscar Hernandez. All rights reserved.
